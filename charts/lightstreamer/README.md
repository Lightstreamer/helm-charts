...
![Version: 0.2.0](https://img.shields.io/badge/Version-0.2.0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 7.4.5](https://img.shields.io/badge/AppVersion-7.4.5-informational?style=flat-square)
...
```
### [license.edition](./values.yaml#L276)
...
**Default:** `"ENTERPRISE"`
### [license.enableAutomaticUpdateCheck](./values.yaml#L407)
...
**Default:** `true`
### [license.enabledCommunityEditionClientApi](./values.yaml#L291)
...
### [license.enterprise](./values.yaml#L294)
...
```
### [license.enterprise.contractId](./values.yaml#L302)

Mandatory, Identifier of the contract in place. Use "DEMO" to run with the embedded Demo license. contractId: EXXXXXXXXX

**Default:** `"DEMO"`
### [license.enterprise.enableAutomaticAuditLogUpload](./values.yaml#L337)
...
**Default:** `true`
### [license.enterprise.filePathSecretRef](./values.yaml#L323)
...
### [license.enterprise.licenseType](./values.yaml#L298)
...
**Default:** `"DEMO"`
### [license.enterprise.licenseValidation](./values.yaml#L313)
...
**Default:** `"ONLINE"`
### [license.enterprise.onlinePasswordSecretRef](./values.yaml#L318)
...
**Default:** `{"key":null,"name":null}`
### [license.enterprise.optionalFeatures](./values.yaml#L339)
...
```
### [license.enterprise.optionalFeatures.enableRestrictedFeaturesSet](./values.yaml#L347)
...
**Default:** `false`
### [license.enterprise.optionalFeatures.features](./values.yaml#L352)
...
**Default:** {}
### [license.enterprise.optionalFeatures.features.enableAndroidClient](./values.yaml#L369)

Mandatory. Android Client API.

**Default:** `false`
### [license.enterprise.optionalFeatures.features.enableBandwidthControl](./values.yaml#L359)

Mandatory. Bandwidth control.

**Default:** `false`
### [license.enterprise.optionalFeatures.features.enableBlackBerryClient](./values.yaml#L394)

Mandatory. BlackBerry Client API.

**Default:** `false`
### [license.enterprise.optionalFeatures.features.enableDotNETStandardClient](./values.yaml#L384)
...
**Default:** `false`
### [license.enterprise.optionalFeatures.features.enableFlashClient](./values.yaml#L398)

Mandatory. Flash Client API.

**Default:** `false`
### [license.enterprise.optionalFeatures.features.enableFlexClient](./values.yaml#L373)

Mandatory. Flex and AIR Client API.

**Default:** `false`
### [license.enterprise.optionalFeatures.features.enableGenericClient](./values.yaml#L400)

Mandatory. Generic Client API.

**Default:** `false`
### [license.enterprise.optionalFeatures.features.enableIOSClient](./values.yaml#L371)

Mandatory. iOS Client API.

**Default:** `false`
### [license.enterprise.optionalFeatures.features.enableJavaMEClient](./values.yaml#L396)

Mandatory. Java ME Client API.

**Default:** `false`
### [license.enterprise.optionalFeatures.features.enableJavaSEClient](./values.yaml#L377)

Mandatory. Java SE Client API.

**Default:** `false`
### [license.enterprise.optionalFeatures.features.enableJavascriptClient](./values.yaml#L365)

Mandatory. JavaScript Client API.

**Default:** `false`
### [license.enterprise.optionalFeatures.features.enableJmx](./values.yaml#L363)

Mandatory. JMX Management API.

**Default:** `false`
### [license.enterprise.optionalFeatures.features.enableMacOSClient](./values.yaml#L386)

Mandatory. macOS Client API.

**Default:** `false`
### [license.enterprise.optionalFeatures.features.enableMpn](./values.yaml#L354)

Mandatory. Mobile Push Notifications.

**Default:** `true`
### [license.enterprise.optionalFeatures.features.enableNodeJsClient](./values.yaml#L367)

Mandatory. Node.js Client API.

**Default:** `false`
### [license.enterprise.optionalFeatures.features.enablePythonClient](./values.yaml#L379)

Mandatory. Python Client API.

**Default:** `false`
### [license.enterprise.optionalFeatures.features.enableSilverlightClient](./values.yaml#L375)

Mandatory. Silverlight Client API.

**Default:** `false`
### [license.enterprise.optionalFeatures.features.enableTlsSsl](./values.yaml#L361)

Mandatory. TLS/SSL Support.

**Default:** `false`
### [license.enterprise.optionalFeatures.features.enableTvOSClient](./values.yaml#L388)

Mandatory. tvOS Client API.

**Default:** `false`
### [license.enterprise.optionalFeatures.features.enableVisionOSClient](./values.yaml#L392)

Mandatory. visionOS Client API.

**Default:** `false`
### [license.enterprise.optionalFeatures.features.enableWatchOSClient](./values.yaml#L390)

Mandatory. watchOS Client API.

**Default:** `false`
### [license.enterprise.optionalFeatures.features.maxDownstreamRate](./values.yaml#L357)

Mandatory. Max message rate (downstream). Possible values: `1`, `3`, `unlimited`.

**Default:** `"1"`
### [license.proxy](./values.yaml#L419)
...
```
### [license.proxy.enableProxyAutodiscovery](./values.yaml#L480)
...
**Default:** `false`
### [license.proxy.httpProxies](./values.yaml#L424)
...
```
### [license.proxy.httpProxies[0].credentialsSecretRef](./values.yaml#L437)
...
**Default:** `nil`
### [license.proxy.httpProxies[0].host](./values.yaml#L428)
...
```
    "[{\"credentialsSecretRef\":null,\"host\":null,\"port\":null,\"version\":null}]"
```
### [license.proxy.socksProxies[0].credentialsSecretRef](./values.yaml#L454)

Mandatory if proxy authentication is required. The name of the  secret containing the credentials. The secret must contain the keys  `user` and `password`.

**Default:** `nil`
### [license.proxy.socksProxies[0].host](./values.yaml#L445)

Optional. Host name or IP address of the proxy server. Examples: "socks.mycompany.com", "192.168.0.9"

**Default:** `nil`
### [license.proxy.socksProxies[0].port](./values.yaml#L447)

Mandatory. Port number of the SOCKS server.

**Default:** `nil`
### [license.proxy.socksProxies[0].version](./values.yaml#L450)
...
```
### [servers.http-server](./values.yaml#L911)
...
```
### [servers.http-server.backlog](./values.yaml#L935)
...
### [servers.http-server.clientIdentification](./values.yaml#L1021)
...
### [servers.http-server.clientIdentification.enableForwardsLogging](./values.yaml#L1086)
...
**Default:** `false`
### [servers.http-server.clientIdentification.enablePrivate](./values.yaml#L1031)
...
**Default:** `false`
### [servers.http-server.clientIdentification.enableProxyProtocol](./values.yaml#L1048)
...
**Default:** `false`
### [servers.http-server.clientIdentification.proxyProtocolTimeoutMillis](./values.yaml#L1058)
...
**Default:** `1000`
### [servers.http-server.clientIdentification.skipLocalForwards](./values.yaml#L1078)
...
**Default:** `0`
### [servers.http-server.enableHttps](./values.yaml#L931)
...
**Default:** `false`
### [servers.http-server.enabled](./values.yaml#L914)

Optional. Enable this socket configuration.

**Default:** `false`
### [servers.http-server.listeningInterface](./values.yaml#L999)
...
```
### [servers.http-server.name](./values.yaml#L921)
...
### [servers.http-server.port](./values.yaml#L923)

Mandatory. Listening TCP port.

**Default:** `8080`
### [servers.http-server.portType](./values.yaml#L969)
...
### [servers.http-server.responseHttpHeaders](./values.yaml#L980)
...
```
### [servers.http-server.responseHttpHeaders.add](./values.yaml#L991)
...
```
### [servers.http-server.responseHttpHeaders.echo](./values.yaml#L985)
...
**Default:** `[]`
### [servers.http-server.sslConfig](./values.yaml#L1089)
...
```
### [servers.http-server.sslConfig.allowCipherSuites](./values.yaml#L1119)
...
**Default:** `[]`
### [servers.http-server.sslConfig.allowProtocols](./values.yaml#L1176)
...
```
### [servers.http-server.sslConfig.enableClientAuth](./values.yaml#L1250)
...
**Default:** `false`
### [servers.http-server.sslConfig.enableClientHintsForTlsSessionResumption](./values.yaml#L1239)
...
**Default:** `false`
### [servers.http-server.sslConfig.enableMandatoryClientAuth](./values.yaml#L1260)
...
**Default:** `false`
### [servers.http-server.sslConfig.enableStatelessTlsSessionResumption](./values.yaml#L1211)
...
```
### [servers.http-server.sslConfig.enableTlsRenegotiation](./values.yaml#L1166)
...
**Default:** `true`
### [servers.http-server.sslConfig.enforceServerCipherSuitePreference](./values.yaml#L1142)
...
```
### [servers.http-server.sslConfig.enforceServerCipherSuitePreference.enabled](./values.yaml#L1149)
...
**Default:** `false`
### [servers.http-server.sslConfig.enforceServerCipherSuitePreference.order](./values.yaml#L1157)

@default `JVM`

**Default:** `"JVM"`
### [servers.http-server.sslConfig.keyStoreRef](./values.yaml#L1105)
...
### [servers.http-server.sslConfig.removeCipherSuites](./values.yaml#L1136)
...
**Default:** `[]`
### [servers.http-server.sslConfig.removeProtocols](./values.yaml#L1193)
...
**Default:** `[]`
### [servers.http-server.sslConfig.tlsProvider](./values.yaml#L1101)
...
```
### [servers.http-server.sslConfig.tlsSessionCacheSize](./values.yaml#L1221)
...
```
### [servers.http-server.sslConfig.tlsSessionTimeoutSeconds](./values.yaml#L1233)
...
```
### [servers.http-server.sslConfig.trustStoreRef](./values.yaml#L1273)
...
### [globalSocket](./values.yaml#L1331)
...
```
### [globalSocket.handshakeTimeoutMillis](./values.yaml#L1349)
...
**Default:** `4000`
### [globalSocket.readTimeoutMillis](./values.yaml#L1339)
...
**Default:** `20000`
### [globalSocket.requestLimit](./values.yaml#L1358)
...
### [globalSocket.useHttpVersion](./values.yaml#L1375)
...
**Default:** `1.1`
### [globalSocket.webSocket](./values.yaml#L1377)
...
```
### [globalSocket.webSocket.enabled](./values.yaml#L1389)
...
**Default:** `true`
### [globalSocket.webSocket.maxClosingWaitMillis](./values.yaml#L1401)
...
```
### [globalSocket.webSocket.maxOutboundFrameSize](./values.yaml#L1407)
...
**Default:** `16384`
### [globalSocket.webSocket.maxPongDelayMillis](./values.yaml#L1396)
...
**Default:** `0`
### [globalSocket.writeTimeoutMillis](./values.yaml#L1366)
...
```
### [security.crossDomainPolicy](./values.yaml#L1468)
...
```
### [security.crossDomainPolicy.acceptCredentials](./values.yaml#L1491)
...
**Default:** `false`
### [security.crossDomainPolicy.acceptExtraHeaders](./values.yaml#L1483)
...
**Default:** `""`
### [security.crossDomainPolicy.allowAccessFrom](./values.yaml#L1494)
...
```
### [security.crossDomainPolicy.allowAccessFrom.fromEveryWere](./values.yaml#L1497)
...
```
    "{\"host\":\"*\",\"port\":\"*\",\"scheme\":\"*\"}"
```
### [security.crossDomainPolicy.allowAccessFrom.fromEveryWere.host](./values.yaml#L1509)
...
**Default:** `"*"`
### [security.crossDomainPolicy.allowAccessFrom.fromEveryWere.port](./values.yaml#L1511)

Mandatory. A a valid port or `*` to specify any port.

**Default:** `"*"`
### [security.crossDomainPolicy.allowAccessFrom.fromEveryWere.scheme](./values.yaml#L1501)
...
**Default:** `"*"`
### [security.crossDomainPolicy.optionsMaxAgeSeconds](./values.yaml#L1476)
...
**Default:** `3600`
### [security.enableCookiesForwarding](./values.yaml#L1446)
...
**Default:** `false`
### [security.enableProtectedJs](./values.yaml#L1435)
...
**Default:** `true`
### [security.serverIdentificationPolicy](./values.yaml#L1569)
...
**Default:** `10000`
### [management.collectorMillis](./values.yaml#L1623)
...
**Default:** `2000`
### [management.dashboard](./values.yaml#L1861)
...
```
### [management.dashboard.availableOnServers](./values.yaml#L1919)
...
```
### [management.dashboard.availableOnServers[0].serverRef](./values.yaml#L1921)

Mandatory. Allowed server socket configuration.

**Default:** `"http-server"`
### [management.dashboard.credentials](./values.yaml#L1892)
...
**Default:** `[]`
### [management.dashboard.credentials[0].secretRef](./values.yaml#L1896)
...
**Default:** `nil`
### [management.dashboard.enableAvailabilityOnAllServers](./values.yaml#L1915)
...
**Default:** `false`
### [management.dashboard.enableHostnameLookup](./values.yaml#L1941)
...
**Default:** `false`
### [management.dashboard.enableJmxTree](./values.yaml#L1873)
...
**Default:** `false`
### [management.dashboard.enablePublicAccess](./values.yaml#L1884)
...
**Default:** `false`
### [management.dashboard.urlPath](./values.yaml#L1930)

Optional. URL path to map the Monitoring Dashboard pages to. An absolute path must be specified.

**Default:** `/dashboard`
### [management.enablePasswordVisibilityOnRequestLog](./values.yaml#L1586)
...
**Default:** `false`
### [management.enableStoppingServiceCheck](./values.yaml#L1836)
...
**Default:** `false`
### [management.healthCheck](./values.yaml#L1950)
...
```
### [management.healthCheck.availableOnServers](./values.yaml#L1962)
...
**Default:** `[]`
### [management.healthCheck.enableAvailabilityOnAllServers](./values.yaml#L1957)
...
**Default:** `false`
### [management.jmx](./values.yaml#L1631)
...
```
    "{\"enableLongListProperties\":false,\"jmxmpConnector\":{\"enabled\":null,\"port\":null},\"rmiConnector\":{\"allowCipherSuites\":[],\"allowProtocols\":[],\"credentialsSecrets\":[],\"dataPort\":{},\"enablePublicAccess\":false,\"enableTestPorts\":true,\"enforceServerCipherSuitePreference\":{\"enabled\":true,\"order\":\"JVM\"},\"hostName\":null,\"keyStoreRef\":null,\"listeningInterface\":null,\"port\":{\"enableSsl\":false,\"value\":8888},\"removeCipherSuites\":[],\"removeProtocols\":[\"SSL\",\"TLSv1$\",\"TLSv1.1\"],\"testTimeoutMillis\":5000},\"sessionMbeanAvailability\":\"inactive\"}"
```
### [management.jmx.enableLongListProperties](./values.yaml#L1823)
...
**Default:** `true`
### [management.jmx.jmxmpConnector](./values.yaml#L1786)
...
### [management.jmx.jmxmpConnector.enabled](./values.yaml#L1789)

Optional. Enables Sun/Oracle's JMXMP connector.

**Default:** `false`
### [management.jmx.jmxmpConnector.port](./values.yaml#L1793)
...
**Default:** `nil`
### [management.jmx.rmiConnector](./values.yaml#L1647)
...
```
    "{\"allowCipherSuites\":[],\"allowProtocols\":[],\"credentialsSecrets\":[],\"dataPort\":{},\"enablePublicAccess\":false,\"enableTestPorts\":true,\"enforceServerCipherSuitePreference\":{\"enabled\":true,\"order\":\"JVM\"},\"hostName\":null,\"keyStoreRef\":null,\"listeningInterface\":null,\"port\":{\"enableSsl\":false,\"value\":8888},\"removeCipherSuites\":[],\"removeProtocols\":[\"SSL\",\"TLSv1$\",\"TLSv1.1\"],\"testTimeoutMillis\":5000}"
```
### [management.jmx.rmiConnector.allowCipherSuites](./values.yaml#L1727)
...
**Default:** `[]`
### [management.jmx.rmiConnector.allowProtocols](./values.yaml#L1749)
...
**Default:** `[]`
### [management.jmx.rmiConnector.credentialsSecrets](./values.yaml#L1778)
...
**Default:** `[]`
### [management.jmx.rmiConnector.dataPort](./values.yaml#L1664)
...
```
### [management.jmx.rmiConnector.enablePublicAccess](./values.yaml#L1767)
...
**Default:** `false`
### [management.jmx.rmiConnector.enableTestPorts](./values.yaml#L1688)
...
**Default:** `true`
### [management.jmx.rmiConnector.enforceServerCipherSuitePreference](./values.yaml#L1742)
...
```
    "{\"enabled\":true,\"order\":\"JVM\"}"
```
### [management.jmx.rmiConnector.hostName](./values.yaml#L1675)
...
```
### [management.jmx.rmiConnector.keyStoreRef](./values.yaml#L1721)
...
```
### [management.jmx.rmiConnector.listeningInterface](./values.yaml#L1712)
...
```
    "accept connections on any/all local addresses"
```
### [management.jmx.rmiConnector.port](./values.yaml#L1653)
...
```
### [management.jmx.rmiConnector.removeCipherSuites](./values.yaml#L1735)
...
**Default:** `[]`
### [management.jmx.rmiConnector.removeProtocols](./values.yaml#L1758)

Optional, but forbidden if `allowProtocols` is used. Pattern to be matched against the names of the enabled TLS/SSL protocols in order to remove the matching ones from the enabled protocols set to be used in case TLS/SSL is enabled for part or all the communication. See notes for `servers.{}.sslConfig.removeProtocols.

**Default:** `["SSL","TLSv1$","TLSv1.1"]`
### [management.jmx.rmiConnector.testTimeoutMillis](./values.yaml#L1703)
...
**Default:** `0`
### [management.jmx.sessionMbeanAvailability](./values.yaml#L1808)
...
**Default:** `inactive`
### [management.maxTaskWaitMillis](./values.yaml#L1616)
...
**Default:** `10000`
### [management.noLoggingIpAddresses](./values.yaml#L1575)

Optional. A set of Clients whose activity is not to be logged.

**Default:** `[]`
### [management.unexpectedWaitThresholdMillis](./values.yaml#L1596)
...
```
### [pushSession.compressionThreshold](./values.yaml#L2065)
...
**Default:** `1024`
### [pushSession.contentLength](./values.yaml#L1998)
...
```
### [pushSession.contentLength.default](./values.yaml#L2001)

Mandatory. Define the maximum size of HTTP streaming responses (and the upper limit for polling responses)

**Default:** `4000000`
### [pushSession.contentLength.specialCases](./values.yaml#L2007)
...
**Default:** `nil`
### [pushSession.defaultDiffOrders](./values.yaml#L2221)
...
**Default:** `[]`
### [pushSession.defaultKeepaliveMillis](./values.yaml#L2296)
...
```
### [pushSession.defaultKeepaliveMillis.randomize](./values.yaml#L2311)
...
**Default:** `false`
### [pushSession.defaultKeepaliveMillis.value](./values.yaml#L2303)
...
**Default:** `5000`
### [pushSession.enableDeltaDelivery](./values.yaml#L2202)
...
**Default:** `true`
### [pushSession.enableEnrichedContentType](./values.yaml#L2074)
...
**Default:** `true`
### [pushSession.jsonPatchMinLength](./values.yaml#L2235)
...
**Default:** `50`
### [pushSession.maxBufferSize](./values.yaml#L2095)
...
### [pushSession.maxDelayMillis](./values.yaml#L2294)
...
**Default:** `0`
### [pushSession.maxIdleMillis](./values.yaml#L2331)
...
```
### [pushSession.maxIdleMillis.randomize](./values.yaml#L2345)
...
**Default:** `false`
### [pushSession.maxIdleMillis.value](./values.yaml#L2338)
...
**Default:** `30000`
### [pushSession.maxKeepaliveMillis](./values.yaml#L2319)
...
**Default:** `30000`
### [pushSession.maxPollingMillis](./values.yaml#L2329)
...
**Default:** `15000`
### [pushSession.maxRecoveryLength](./values.yaml#L2134)
...
```
### [pushSession.maxRecoveryPollLength](./values.yaml#L2144)
...
**Default:** `-1`
### [pushSession.maxStreamingMillis](./values.yaml#L2024)
...
```
### [pushSession.minInterPollMillis](./values.yaml#L2358)
...
**Default:** `0`
### [pushSession.minKeepaliveMillis](./values.yaml#L2315)
...
**Default:** `1000`
### [pushSession.missingMessageTimeoutMillis](./values.yaml#L2176)
...
**Default:** `30000`
### [pushSession.preserveUnfilteredCommandOrdering](./values.yaml#L2250)
...
**Default:** `false`
### [pushSession.reusePumpBuffers](./values.yaml#L2265)
...
**Default:** `AUTO`
### [pushSession.sendbuf](./values.yaml#L2287)
...
**Default:** `1600`
### [pushSession.serviceUrlPrefixes](./values.yaml#L1981)
...
**Default:** `[]`
### [pushSession.sessionRecoveryMillis](./values.yaml#L2124)
...
**Default:** `0`
### [pushSession.sessionTimeoutMillis](./values.yaml#L2107)
...
**Default:** `10000`
### [pushSession.subscriptionTimeoutMillis](./values.yaml#L2157)
...
**Default:** `5000`
### [pushSession.useChunkedEncoding](./values.yaml#L2040)
...
**Default:** `true`
### [pushSession.useCompression](./values.yaml#L2059)
...
```
### [keyStores.myKafkaConnectorKeystore](./values.yaml#L1306)

Example of Keystore definition used by Kafka connector configurations.

**Default:** `nil`
### [keyStores.myServerKeystore](./values.yaml#L1284)
...
```
### [keyStores.myServerKeystore.keystoreFileSecretRef](./values.yaml#L1297)
...
```
### [keyStores.myServerKeystore.keystorePasswordSecretRef](./values.yaml#L1302)
...
```
### [keyStores.myServerKeystore.type](./values.yaml#L1294)
...
```
### [webServer.compressionThreshold](./values.yaml#L2823)
...
**Default:** `8192`
### [webServer.enableFlexCrossdomain](./values.yaml#L2845)
...
**Default:** `false`
### [webServer.enableSilverlightAccessPolicy](./values.yaml#L2873)
...
**Default:** `false`
### [webServer.enabled](./values.yaml#L2779)
...
**Default:** `false`
### [webServer.errorPageRef](./values.yaml#L2789)
...
```
### [webServer.flexCrossdomainPath](./values.yaml#L2851)
...
**Default:** `nil`
### [webServer.mimeTypesConfig](./values.yaml#L2812)
...
### [webServer.notFoundPage](./values.yaml#L2818)
...
```
    "the proper page is provided by the Server"
```
### [webServer.pagesDir](./values.yaml#L2802)
...
**Default:** `../pages`
### [webServer.persistencyMinutes](./values.yaml#L2808)
...
**Default:** `0`
### [webServer.silverlightAccessPolicyPath](./values.yaml#L2880)
...
```
### [cluster.maxSessionDurationMinutes](./values.yaml#L2942)
...
```
### [load.acceptPoolMaxSize](./values.yaml#L3098)
...
```
### [load.eventsPoolSize](./values.yaml#L3009)
...
```
    "the number of available total cores, as detected by the JVM"
```
### [load.forceEarlyConversions](./values.yaml#L3206)
...
**Default:** `true`
### [load.handshakePoolMaxQueue](./values.yaml#L3151)
...
**Default:** `100`
### [load.handshakePoolSize](./values.yaml#L3126)
...
```
### [load.httpsAuthPoolMaxFree](./values.yaml#L3162)
...
```
### [load.httpsAuthPoolMaxQueue](./values.yaml#L3172)
...
**Default:** `100`
### [load.httpsAuthPoolMaxSize](./values.yaml#L3157)
...
```
    "the same as configured for the SERVER thread pool"
```
### [load.maxCommonNioBufferAllocation](./values.yaml#L2971)
...
**Default:** `200000000`
### [load.maxCommonPumpBufferAllocation](./values.yaml#L2979)
...
```
    "the number of available total cores, as detected by the JVM"
```
### [load.maxMpnDevices](./values.yaml#L2963)
...
```
### [load.maxSessions](./values.yaml#L2955)
...
```
### [load.prestartedMaxQueue](./values.yaml#L3192)
...
**Default:** `-1`
### [load.pumpPoolMaxQueue](./values.yaml#L3034)
...
**Default:** `-1`
### [load.pumpPoolSize](./values.yaml#L3024)
...
```
    "the number of available total cores, as detected by the JVM"
```
### [load.selectorMaxLoad](./values.yaml#L2995)
...
**Default:** `0`
### [load.selectorPoolSize](./values.yaml#L2987)
...
```
    "the number of available total cores, as detected by the JVM"
```
### [load.serverPoolMaxFree](./values.yaml#L3071)
...
```
### [load.serverPoolMaxQueue](./values.yaml#L3084)
...
**Default:** `100`
### [load.serverPoolMaxSize](./values.yaml#L3055)
...
**Default:** `1000`
### [load.snapshotPoolSize](./values.yaml#L3017)
...
```
### [load.timerPoolSize](./values.yaml#L3002)
...
```
### [connectors.kafkaConnector](./values.yaml#L3211)
...
```
### [connectors.kafkaConnector.adapterClassName](./values.yaml#L3223)
...
```
### [connectors.kafkaConnector.adapterSetId](./values.yaml#L3218)

Mandatory. Define the Kafka Connector Adapter Set and its unique ID.

**Default:** `"KafkaConnector"`
### [connectors.kafkaConnector.connections](./values.yaml#L3258)
...
```
    "{\"quickStart\":{\"authentication\":{\"credentialsSecretRef\":null,\"enabled\":false,\"gssapi\":{\"enableKeytab\":null,\"enableStoreKey\":null,\"enableTicketCache\":null,\"kerberosServiceName\":null,\"keytabFilePathRef\":null,\"principal\":null}},\"bootstrapServers\":\"broker:9092\",\"enabled\":true,\"fields\":{\"enableSkipFailedMapping\":null,\"mappings\":{\"ask\":\"#{VALUE.ask}\",\"ask_quantity\":\"#{VALUE.ask_quantity}\",\"bid\":\"#{VALUE.bid}\",\"bid_quantity\":\"#{VALUE.bid_quantity}\",\"item_status\":\"#{VALUE.item_status}\",\"last_price\":\"#{VALUE.last_price}\",\"max\":\"#{VALUE.max}\",\"min\":\"#{VALUE.min}\",\"offset\":\"#{OFFSET}\",\"open_price\":\"#{VALUE.open_price}\",\"partition\":\"#{PARTITION}\",\"pct_change\":\"#{VALUE.pct_change}\",\"ref_price\":\"#{VALUE.ref_price}\",\"stock_name\":\"#{VALUE.name}\",\"time\":\"#{VALUE.time}\",\"timestamp\":\"#{VALUE.timestamp}\",\"topic\":\"#{TOPIC}\",\"ts\":\"#{TIMESTAMP}\"}},\"groupId\":\"quickstart\",\"logger\":{\"appenders\":[\"stdout\"],\"level\":\"INFO\"},\"name\":\"K8S-QuickStart\",\"record\":{\"consumeFrom\":\"EARLIEST\",\"consumeWithOrderStrategy\":null,\"consumeWithThreadNumber\":null,\"extractionErrorStrategy\":null,\"keyEvaluator\":{\"enableSchemaRegistry\":null,\"localSchemaFilePathRef\":null,\"type\":\"INTEGER\"},\"schemaRegistryRef\":null,\"valueEvaluator\":{\"enableSchemaRegistry\":null,\"localSchemaFilePathRef\":null,\"type\":\"JSON\"}},\"routing\":{\"enableTopicRegEx\":null,\"itemTemplates\":{\"stockTemplate\":\"stock-#{index=KEY}\"},\"topicMappings\":{\"stock\":{\"itemTemplateRefs\":[\"stockTemplate\"],\"items\":[],\"topic\":\"stock\"}}},\"sslConfig\":{\"allowedCipherSuites\":[],\"allowedProtocols\":[],\"enableHostnameVerification\":null,\"enabled\":true,\"keyStoreRef\":null,\"protocol\":null,\"trustStoreRef\":null}}}"
```
### [connectors.kafkaConnector.connections.quickStart](./values.yaml#L3265)
...
```
### [connectors.kafkaConnector.connections.quickStart.authentication](./values.yaml#L3323)
...
```
### [connectors.kafkaConnector.connections.quickStart.authentication.credentialsSecretRef](./values.yaml#L3341)
...
**Default:** `nil`
### [connectors.kafkaConnector.connections.quickStart.authentication.enabled](./values.yaml#L3327)

Optional. Enablement of the authentication of the connection  against the Kafka Cluster.

**Default:** `false`
### [connectors.kafkaConnector.connections.quickStart.authentication.gssapi](./values.yaml#L3344)
...
```
### [connectors.kafkaConnector.connections.quickStart.authentication.gssapi.enableKeytab](./values.yaml#L3347)

Optional. Enablement of the use of a keytab.

**Default:** `false`
### [connectors.kafkaConnector.connections.quickStart.authentication.gssapi.enableStoreKey](./values.yaml#L3355)

Optional. Enablement of the storage of the principal key.

**Default:** `false`
### [connectors.kafkaConnector.connections.quickStart.authentication.gssapi.enableTicketCache](./values.yaml#L3363)

Optional. Enablement of the use of a ticket cache.

**Default:** `false`
### [connectors.kafkaConnector.connections.quickStart.authentication.gssapi.kerberosServiceName](./values.yaml#L3357)

Mandatory. The name of the Kerberos service.

**Default:** `nil`
### [connectors.kafkaConnector.connections.quickStart.authentication.gssapi.keytabFilePathRef](./values.yaml#L3350)

Mandatory if `enableKeytab` is set to `true`. The configmap name and key where the the keytab file is stored

**Default:** `nil`
### [connectors.kafkaConnector.connections.quickStart.authentication.gssapi.principal](./values.yaml#L3360)

Mandatory if enableTicketCache is set to `true`.  The name of the principal to be used.

**Default:** `nil`
### [connectors.kafkaConnector.connections.quickStart.bootstrapServers](./values.yaml#L3281)
...
**Default:** `"broker:9092"`
### [connectors.kafkaConnector.connections.quickStart.enabled](./values.yaml#L3277)
...
**Default:** `true`
### [connectors.kafkaConnector.connections.quickStart.fields](./values.yaml#L3523)
...
```
### [connectors.kafkaConnector.connections.quickStart.fields.enableSkipFailedMapping](./values.yaml#L3555)
...
**Default:** `false`
### [connectors.kafkaConnector.connections.quickStart.fields.mappings.timestamp](./values.yaml#L3532)
...
### [connectors.kafkaConnector.connections.quickStart.groupId](./values.yaml#L3290)

Optional. The name of the consumer group this connection  belongs to. Sets the value for the "group.id" key used to configure the internal Kafka Consumer. See https://kafka.apache.org/documentation/#consumerconfigs_group.id for details. generated suffix.
...
```
### [connectors.kafkaConnector.connections.quickStart.logger](./values.yaml#L3557)
...
```
### [connectors.kafkaConnector.connections.quickStart.logger.appenders](./values.yaml#L3560)

Mandatory. List of references to the appenders defined in  `kafkaConnector.logging.appenders`.

**Default:** `["stdout"]`
### [connectors.kafkaConnector.connections.quickStart.logger.level](./values.yaml#L3563)

Mandatory. The logger level.

**Default:** `"INFO"`
### [connectors.kafkaConnector.connections.quickStart.name](./values.yaml#L3272)
...
### [connectors.kafkaConnector.connections.quickStart.record](./values.yaml#L3366)

Optional. Record evaluation settings.

**Default:** all settings at their defaults
### [connectors.kafkaConnector.connections.quickStart.record.consumeFrom](./values.yaml#L3374)
...
**Default:** `LATEST`
### [connectors.kafkaConnector.connections.quickStart.record.consumeWithOrderStrategy](./values.yaml#L3391)
...
### [connectors.kafkaConnector.connections.quickStart.record.consumeWithThreadNumber](./values.yaml#L3380)
...
**Default:** `1`
### [connectors.kafkaConnector.connections.quickStart.record.extractionErrorStrategy](./values.yaml#L3452)
...
### [connectors.kafkaConnector.connections.quickStart.record.keyEvaluator](./values.yaml#L3394)

Optional. Key evaluator configuration.

**Default:** all settings at their defaults
### [connectors.kafkaConnector.connections.quickStart.record.keyEvaluator.enableSchemaRegistry](./values.yaml#L3423)
...
**Default:** `false`
### [connectors.kafkaConnector.connections.quickStart.record.keyEvaluator.localSchemaFilePathRef](./values.yaml#L3417)
...
**Default:** `nil`
### [connectors.kafkaConnector.connections.quickStart.record.keyEvaluator.type](./values.yaml#L3411)
...
**Default:** `STRING`
### [connectors.kafkaConnector.connections.quickStart.record.schemaRegistryRef](./values.yaml#L3455)

Optional. The reference to Schema Registry configuration defined in `connectors.kafkaConnector.schemaRegistry`.

**Default:** `nil`
### [connectors.kafkaConnector.connections.quickStart.record.valueEvaluator](./values.yaml#L3426)

Optional. Value evaluator configuration.

**Default:** all settings at their defaults
### [connectors.kafkaConnector.connections.quickStart.record.valueEvaluator.enableSchemaRegistry](./values.yaml#L3443)
...
**Default:** `false`
### [connectors.kafkaConnector.connections.quickStart.record.valueEvaluator.localSchemaFilePathRef](./values.yaml#L3437)
...
**Default:** `nil`
### [connectors.kafkaConnector.connections.quickStart.record.valueEvaluator.type](./values.yaml#L3431)
...
**Default:** `STRING`
### [connectors.kafkaConnector.connections.quickStart.routing](./values.yaml#L3457)
...
```
### [connectors.kafkaConnector.connections.quickStart.routing.enableTopicRegEx](./values.yaml#L3521)
...
**Default:** `false`
### [connectors.kafkaConnector.connections.quickStart.routing.itemTemplates](./values.yaml#L3464)
...
**Default:** `{}`
### [connectors.kafkaConnector.connections.quickStart.routing.topicMappings](./values.yaml#L3467)
...
```
### [connectors.kafkaConnector.connections.quickStart.routing.topicMappings.stock](./values.yaml#L3500)
...
```
### [connectors.kafkaConnector.connections.quickStart.routing.topicMappings.stock.itemTemplateRefs](./values.yaml#L3514)

Mandatory if `items` is empty. List of item template to which the topic must be mapped.

**Default:** `[]`
### [connectors.kafkaConnector.connections.quickStart.routing.topicMappings.stock.items](./values.yaml#L3507)

Mandatory if `itemTemplateRefs` is empty. List of simple items to which the topic must be mapped.

**Default:** `[]`
### [connectors.kafkaConnector.connections.quickStart.routing.topicMappings.stock.topic](./values.yaml#L3503)

Mandatory and unique across all topic mappings. The Kafka  topic name.

**Default:** `"stock"`
### [connectors.kafkaConnector.connections.quickStart.sslConfig](./values.yaml#L3293)

Optional. TLS/SSL settings for the connection.

**Default:** all settings at their defaults
### [connectors.kafkaConnector.connections.quickStart.sslConfig.allowedCipherSuites](./values.yaml#L3308)
...
```
### [connectors.kafkaConnector.connections.quickStart.sslConfig.allowedProtocols](./values.yaml#L3305)
...
```
### [connectors.kafkaConnector.connections.quickStart.sslConfig.enableHostnameVerification](./values.yaml#L3311)

Optional. Enablement of the hostname verification.

**Default:** `false`
### [connectors.kafkaConnector.connections.quickStart.sslConfig.enabled](./values.yaml#L3296)

Optional. Enablement of the encryption.

**Default:** `false`
### [connectors.kafkaConnector.connections.quickStart.sslConfig.keyStoreRef](./values.yaml#L3321)
...
**Default:** `nil`
### [connectors.kafkaConnector.connections.quickStart.sslConfig.protocol](./values.yaml#L3301)
...
```
### [connectors.kafkaConnector.connections.quickStart.sslConfig.trustStoreRef](./values.yaml#L3316)
...
**Default:** `nil`
### [connectors.kafkaConnector.enabled](./values.yaml#L3214)

Optional. Enablement of the Lightstreamer Kafka Connector.

**Default:** `false`
### [connectors.kafkaConnector.localSchemaFiles](./values.yaml#L3565)
...
```
### [connectors.kafkaConnector.localSchemaFiles.myKeySchema](./values.yaml#L3568)

Optional. The configmap name and key where the local schema file is stored.

**Default:** `nil`
### [connectors.kafkaConnector.logging](./values.yaml#L3225)
...
```
### [connectors.kafkaConnector.logging.appenders](./values.yaml#L3228)
...
```
### [connectors.kafkaConnector.logging.appenders.stdout](./values.yaml#L3230)
...
```
### [connectors.kafkaConnector.logging.appenders.stdout.pattern](./values.yaml#L3235)

Mandatory. The appender layout.

**Default:** `"[%d] [%-10c{1}] %-5p %m%n"`
### [connectors.kafkaConnector.logging.appenders.stdout.type](./values.yaml#L3233)

Mandatory. The appender type. Currently, only the `Console` type is supported.

**Default:** `"Console"`
### [connectors.kafkaConnector.logging.loggers](./values.yaml#L3237)
...
```
### [connectors.kafkaConnector.logging.loggers."com.lightstreamer.kafka.adapters.pub.KafkaConnectorMetadataAdapter"](./values.yaml#L3248)
...
```
    "{\"appenders\":[\"stdout\"],\"level\":\"INFO\"}"
```
### [connectors.kafkaConnector.logging.loggers."org.apache.kafka"](./values.yaml#L3239)
...
```
### [connectors.kafkaConnector.logging.loggers."org.apache.kafka".appenders](./values.yaml#L3242)

Mandatory. List of references to the appenders to be used by   the logger.

**Default:** `["stdout"]`
### [connectors.kafkaConnector.logging.loggers."org.apache.kafka".level](./values.yaml#L3245)

Mandatory. The logger level.

**Default:** `"WARN"`
### [connectors.kafkaConnector.schemaRegistry](./values.yaml#L3576)
...
```
### [connectors.kafkaConnector.schemaRegistry.mySchemaRegistry](./values.yaml#L3580)
...
```
### [connectors.kafkaConnector.schemaRegistry.mySchemaRegistry.basicAuthentication](./values.yaml#L3586)
...
```
### [connectors.kafkaConnector.schemaRegistry.mySchemaRegistry.basicAuthentication.credentialsSecretRef](./values.yaml#L3593)
...
**Default:** `nil`
### [connectors.kafkaConnector.schemaRegistry.mySchemaRegistry.basicAuthentication.enabled](./values.yaml#L3589)

Optional. Enablement of the Basic HTTP authentication.

**Default:** `false`
### [connectors.kafkaConnector.schemaRegistry.mySchemaRegistry.sslConfig](./values.yaml#L3596)
...
```
### [connectors.kafkaConnector.schemaRegistry.mySchemaRegistry.sslConfig.allowCipherSuites](./values.yaml#L3605)
...
```
    "all the available cipher suites in the running JVM"
```
### [connectors.kafkaConnector.schemaRegistry.mySchemaRegistry.sslConfig.allowProtocols](./values.yaml#L3600)
...
```
    "[TLSv1.2, TLSv1.3] when running on Java 11 or newer,"
```
### [connectors.kafkaConnector.schemaRegistry.mySchemaRegistry.sslConfig.enableHostnameVerification](./values.yaml#L3609)

Optional. Enablement of the hostname verification.

**Default:** `false`
### [connectors.kafkaConnector.schemaRegistry.mySchemaRegistry.sslConfig.keyStoreRef](./values.yaml#L3619)
...
**Default:** `nil`
### [connectors.kafkaConnector.schemaRegistry.mySchemaRegistry.sslConfig.trustStoreRef](./values.yaml#L3614)
...
**Default:** `nil`
### [connectors.kafkaConnector.schemaRegistry.mySchemaRegistry.url](./values.yaml#L3583)
...
```
### [connectors.kafkaConnector.version](./values.yaml#L3216)
