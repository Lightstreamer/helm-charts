...
Optional. Settings that allow for better recognition of the remote address of the connected clients. This can be done in two ways: - by taking advantage of the X-Forwarded-For HTTP header, that   intermediate HTTP proxies and level-7 Load Balancers usually set to   supply connection routing information in an incremental way (this is   done through the `clientIdentification.skipLocalForwards` setting); - by receiving the routed address directly from a TCP reverse proxy or   level-4 Load Balancer through the Proxy Protocol, when the proxy is   configured to do so (this is done through the    `clientIdentification.enableProxyProtocol` setting). The two techniques can also coexist, but, in that case, the address through the proxy protocol would always be considered as the real client address and all addresses in the chain specified in X-Forwarded-For would be considered as written by client-side proxies. The address determined in this way will be used in all cases in which the client address is reported or checked. For logging purposes, the connection endpoint will still be written, but the real remote address, if available and different, will be added. The determined address may also be sent to the clients, depending on the Client SDK in use.
...
**Default:** `false`
#### [servers.defaultServer.listeningInterface](./values.yaml#L1019)
...
**Default:** `8080`
#### [servers.defaultServer.portType](./values.yaml#L989)
...
#### [servers.defaultServer.responseHttpHeaders](./values.yaml#L1000)
...
#### [servers.defaultServer.responseHttpHeaders.echo](./values.yaml#L1005)
...
**Default:** `false`
#### [servers.defaultServer.sslConfig.enableClientHintsForTlsSessionResumption](./values.yaml#L1260)
...
**Default:** `false`
#### [servers.defaultServer.sslConfig.enableMandatoryClientAuth](./values.yaml#L1281)
...
**Default:** `nil`
#### [keyStores.myServerKeystore](./values.yaml#L1305)
...
#### [globalSocket](./values.yaml#L1352)
...
**Default:** `4000`
#### [globalSocket.readTimeoutMillis](./values.yaml#L1360)
...
**Default:** `20000`
#### [globalSocket.requestLimit](./values.yaml#L1379)
...
#### [globalSocket.useHttpVersion](./values.yaml#L1396)
...
**Default:** `1.1`
#### [globalSocket.webSocket](./values.yaml#L1398)
...
**Default:** `true`
#### [globalSocket.webSocket.maxClosingWaitMillis](./values.yaml#L1422)
...
**Default:** `16384`
#### [globalSocket.webSocket.maxPongDelayMillis](./values.yaml#L1417)
...
**Default:** `0`
#### [globalSocket.writeTimeoutMillis](./values.yaml#L1387)
...
**Default:** `false`
#### [security.crossDomainPolicy.acceptExtraHeaders](./values.yaml#L1504)
...
**Default:** `""`
#### [security.crossDomainPolicy.allowAccessFrom](./values.yaml#L1515)
...
#### [security.crossDomainPolicy.allowAccessFrom.fromEveryWere.host](./values.yaml#L1530)
...
**Default:** `"*"`
#### [security.crossDomainPolicy.allowAccessFrom.fromEveryWere.port](./values.yaml#L1532)

     
Mandatory. A a valid port or `*` to specify any port.

**Default:** `"*"`
#### [security.crossDomainPolicy.allowAccessFrom.fromEveryWere.scheme](./values.yaml#L1522)
...
**Default:** `"*"`
#### [security.crossDomainPolicy.optionsMaxAgeSeconds](./values.yaml#L1497)
...
**Default:** `3600`
#### [security.enableCookiesForwarding](./values.yaml#L1467)
...
**Default:** `false`
#### [security.enableProtectedJs](./values.yaml#L1456)
...
**Default:** `true`
#### [security.serverIdentificationPolicy](./values.yaml#L1590)
...
**Default:** `10000`
#### [management.collectorMillis](./values.yaml#L1644)
...
**Default:** `/dashboard`
#### [management.enablePasswordVisibilityOnRequestLog](./values.yaml#L1607)
...
**Default:** `false`
#### [management.jmx](./values.yaml#L1652)
...
**Default:** `nil`
#### [management.jmx.rmiConnector](./values.yaml#L1668)
...
**Default:** `[]`
#### [management.jmx.rmiConnector.dataPort](./values.yaml#L1685)
...
**Default:** `false`
#### [management.jmx.rmiConnector.enableTestPorts](./values.yaml#L1709)
...
**Default:** `{"enabled":true,"order":"JVM"}`
#### [management.jmx.rmiConnector.hostName](./values.yaml#L1696)
...
#### [management.jmx.rmiConnector.testTimeoutMillis](./values.yaml#L1724)
...
**Default:** `inactive`
#### [management.maxTaskWaitMillis](./values.yaml#L1637)
...
**Default:** `10000`
#### [management.noLoggingIpAddresses](./values.yaml#L1596)

     
Optional. A set of Clients whose activity is not to be logged.

**Default:** `[]`
#### [management.unexpectedWaitThresholdMillis](./values.yaml#L1617)
...
**Default:** `[]`
#### [mpn.appleNotifierConfig.connectionTimeout](./values.yaml#L2632)
